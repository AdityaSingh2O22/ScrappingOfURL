# -*- coding: utf-8 -*-
"""
Created on Thu Feb  2 22:02:26 2023
...
def scrape_product_info(url):
    ...
    if response.status_code == 200:
        ...
        for product in soup.find_all("div", class_="s-result-item"):
            ...
            product_info["asin"] = asin if asin else None
            manufacturer = product.find("span", class_="a-size-base-plus a-color-secondary")
            product_info["manufacturer"] = manufacturer.text.strip() if manufacturer else None
            description = product.find("div", class_="a-section a-text-left")
...
headers = ["product_url", "product_name", "product_price", "rating", "review_count", "asin", "manufacturer", "description"]
